...
Variant 3 is a process/hybrid version of SWO. The final Variant was developed by
...
thus are are indexed then from 0 to 3.
...
similar to that of the database for the SMC variant of CONIFERS
